                    ...
                    >
                        ...
                        >
                            <button
                                ...
                                className={`flex-1 py-2 px-4 rounded-md text-sm font-medium transition-colors ${activeTab === 'predefined'
                            ...
                            <button
                                ...
                                className={`flex-1 py-2 px-4 rounded-md text-sm font-medium transition-colors ${activeTab === 'custom'
                                    ? 'bg-white text-gray-800 shadow-sm'
                                    : 'text-gray-600 hover:text-gray-800'
                                    }`}
                            >
                        ...
                        {activeTab === 'custom' && (
                            <div className="space-y-4">
                                        ...
                                        {availableIcons.map((iconName) => {
                                            ...
                                            return (
                                                <button
                                                    ...
                                                    className={`w-10 h-10 rounded-lg flex items-center justify-center transition-colors ${customHabit.icon === iconName
                                    ...
                                    <div className="flex gap-2">
                                        {Object.values(categoryColors).map((color) => (
                                            <button
                                                ...
                                                className={`w-8 h-8 rounded-full transition-transform ${customHabit.color === color ? 'scale-110 ring-2 ring-gray-300' : ''
                                                    }`}
                                ...
                                <button
                                    ...
                                    className="w-full py-3 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                                >
